...
var $author$project$Main$init = {userInput: ''};
...
var $author$project$Main$viewCodeWithHighlight = function (input) {
	var parts = A2($elm$core$String$split, '```', input);
	var maybeLanguageAndCode = function () {
		if (((((parts.b && (parts.a === '')) && parts.b.b) && parts.b.b.b) && (parts.b.b.a === '')) && (!parts.b.b.b.b)) {
			var _v3 = parts.b;
			var languageAndCode = _v3.a;
			var _v4 = _v3.b;
			var _v5 = $elm$core$String$lines(languageAndCode);
			if (_v5.b) {
				var language = _v5.a;
				var codeLines = _v5.b;
				return $elm$core$Maybe$Just(
					{
						code: A2($elm$core$String$join, '\n', codeLines),
						language: $elm$core$String$trim(language)
					});
			} else {
				return $elm$core$Maybe$Nothing;
			}
	...
	if (maybeLanguageAndCode.$ === 'Just') {
		var language = maybeLanguageAndCode.a.language;
		var code = maybeLanguageAndCode.a.code;
		switch (language) {
			case 'python':
				return A2(
			...
			default:
				return $elm$html$Html$text('Unsupported language. Try \'python\', \'javascript\', or \'elm\'');
		}
	} else {
		return $elm$html$Html$text('Format: ```language\\nyour code here```');
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Syntax Highlighting Demo')
					])),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$placeholder('Type your code here...\nExample:\n```python\ndef hello():\n    print(\'Hello!\')\n```'),
						$elm$html$Html$Attributes$value(model.userInput),
						$elm$html$Html$Events$onInput($author$project$Main$UpdateInput)
					]),
				_List_Nil),
				$author$project$Main$viewCodeWithHighlight(model.userInput)
			]));
};
